 ...
 */
@WebServlet("/Sl_rptListEmpresas")
public class Sl_rptListEmpresas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sl_rptListEmpresas() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String template = "reportes\\rptListEmpresa.jasper";
			...
			response.setHeader("Content-Disposition", "inline; filename=\"rptListEmpresa.pdf");
