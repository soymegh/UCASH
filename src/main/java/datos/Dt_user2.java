...
public class Dt_user2 {
	...
	public void llenaRsUser2(Connection c){
		try{
			ps = c.prepareStatement("SELECT * FROM dbucash.usuario2;", ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE, ResultSet.HOLD_CURSORS_OVER_COMMIT);
	...
	try{
		...
		rsUser2.updateInt("idUsuario", tus2.getId_user());
		rsUser2.updateString("tokens", tus2.getToken());
		rsUser2.insertRow();
