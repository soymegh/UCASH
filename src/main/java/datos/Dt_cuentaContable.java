...
public class Dt_cuentaContable {
	...
	public ArrayList<Vw_catalogo_tipo_cuentacontable> getCuentaContableByIdEmpresaActivos(int idEmpresa) {
		ArrayList<Vw_catalogo_tipo_cuentacontable> listCuentaContable = new ArrayList<Vw_catalogo_tipo_cuentacontable>();
		try {
			c = poolConexion.getConnection();
			this.ps = this.c.prepareStatement(
					"SELECT * FROM dbucash.vw_catalogo_tipo_cuentacontable WHERE estado <> 3 AND idEmpresa=? AND tipoCuenta = 'Activo'",
					ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
			ps.setInt(1, idEmpresa);
			rs = ps.executeQuery();
	...
	public ArrayList<Vw_catalogo_tipo_cuentacontable> getCuentaContableByIdEmpresaPasivos(int idEmpresa) {
		ArrayList<Vw_catalogo_tipo_cuentacontable> listCuentaContable = new ArrayList<Vw_catalogo_tipo_cuentacontable>();
		try {
			c = poolConexion.getConnection();
			this.ps = this.c.prepareStatement(
					"SELECT * FROM dbucash.vw_catalogo_tipo_cuentacontable WHERE estado <> 3 AND idEmpresa=? AND tipoCuenta = 'Pasivo'",
					ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
			ps.setInt(1, idEmpresa);
			rs = ps.executeQuery();
	...
	public ArrayList<Vw_catalogo_tipo_cuentacontable> getCuentaContableByIdEmpresaCapital(int idEmpresa) {
		ArrayList<Vw_catalogo_tipo_cuentacontable> listCuentaContable = new ArrayList<Vw_catalogo_tipo_cuentacontable>();
		try {
			c = poolConexion.getConnection();
			this.ps = this.c.prepareStatement(
					"SELECT * FROM dbucash.vw_catalogo_tipo_cuentacontable WHERE estado <> 3 AND idEmpresa=? AND tipoCuenta = 'Capital'",
					ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
			ps.setInt(1, idEmpresa);
			rs = ps.executeQuery();
	...
	public ArrayList<Vw_catalogo_tipo_cuentacontable> getCuentaContableByIdEmpresaCapitalYResultados(int idEmpresa) {
		ArrayList<Vw_catalogo_tipo_cuentacontable> listCuentaContable = new ArrayList<Vw_catalogo_tipo_cuentacontable>();
		try {
			c = poolConexion.getConnection();
			this.ps = this.c.prepareStatement(
					"SELECT * FROM dbucash.vw_catalogo_tipo_cuentacontable WHERE estado <> 3 AND idEmpresa=? AND tipoCuenta = 'Capital' OR tipoCuenta = 'Resultado'",
					ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
			ps.setInt(1, idEmpresa);
			rs = ps.executeQuery();
	...
	public ArrayList<Tbl_cuentaContable> getCuentasContablesByCatalogo(int id) {
		...
		try {
			...
			while (this.rs.next()) {
				...
				cc.setIdCatalogo(this.rs.getInt("idCatalogo"));
				cc.setNumeroCuenta(this.rs.getString("numeroCuenta"));
				cc.setsC(this.rs.getString("SC"));
				cc.setSsC(this.rs.getString("SsC"));
				cc.setSssC(this.rs.getString("SssC"));
