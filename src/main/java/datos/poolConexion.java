...
public class poolConexion {
    ...
    private static String url = "jdbc:mysql://localhost:3306/dbucash?autoReconnect=true&useSSL=false&serverTimezone=America/Managua";
    private static String user = "root";
    private static String pass = "Temporal2022+";
