...
<title>Gestion | Editar Rol</title>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<form class="" action="../Sl_rol" method="post" novalidate>
										...
										<input type="hidden" value="<%=r.getIdRol() %>" name="idRolUpdate" id="idRolUpdate" />
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" class='optional'
													name="txtNombre" type="text" value="<%=r.getNombre() %>" required="required"
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" class='optional'
													name="descripcion" type="text" value="<%=r.getDescripcion() %>" required="required"
