...
<title>Gesti�n | Tasa Cambio</title>
...
<body class="nav-md">
	...
	<script>
			...
			$(document).ready(function() {
                if (mensaje == "1") {
                    successAlert('Exito', 'La opci�n ha sido registrada correctamente.')
                }
                
                if (mensaje == "2") {
                	errorAlert('Error', 'Los datos de la opci�n no se han podido guardar.')
                }
                
                if (mensaje == "3") {
                	successAlert('Exito', 'Los datos de la opci�n se han editado correctamente.')
                }
                
                if (mensaje == "4") {
                	errorAlert('Error', 'Los datos de la opci�n no se han editado correctamente.')
                }
                
                if (mensaje == "5") {
                	successAlert('Exito', 'Los datos de la opci�n se han eliminado correctamente.')
                }
                
                if (mensaje == "6") {
                	errorAlert('Error', 'Los datos de la opci�n no se han eliminado correctamente.')
                }
                $("#example1").DataTable({
                    "responsive": true,
                    "lengthChange": false,
