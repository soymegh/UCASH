...
<title>Abrir | Periodo Fiscal</title>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<form class="" action="../Sl_periodoFiscal" method="post" novalidate>
									  <input type="hidden" value="5" name="opcion" id="opcion"/>
									  
									  <input type="hidden" value="<%=tpfiscal.getIdPeriodoFiscal()%>" name="idPFiscalAbrir" id="idPFiscalAbrir" />
