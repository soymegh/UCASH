...
<title>Ver | Asiento Contable Detalle</title>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Mostrar Asiento Contable Detalle</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Formulario <small>Mostrar Asiento Contable Detalle</small>
									</h2>
								...
								<div class="x_content">
									<form class="" action="" method="post" novalidate>
										<span class="section">Datos de Asiento Contable Detalle</span>
										...
										<div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Descripcion<span readonly>*</span>
											</label>
											<div class="col-md-6 col-sm-6">
										...
										<div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Nombre de la Cuenta<span
												readonly>*</span></label>
											<div class="col-md-6 col-sm-6">
										...
										<div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Saldo<span readonly>*</span>
											</label>
											<div class="col-md-6 col-sm-6">
										...
										<div class="ln_solid">
											<div class="form-group">
												<div class="col-md-6 offset-md-3">
													<a href="tbl_asientoContable.jsp" class="btn btn-primary">Regresar</a>
												</div>
											</div>
										</div>
									</form>
