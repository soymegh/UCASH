...
int idUserRol = (request.getParameter("idUR") != null) ? Integer.parseInt(request.getParameter("idUR")) : 0;

userRol = datosUsuarioRol.ObtenerUsuarioRolPorId(idUserRol);
%>
<head>
...
<title>Ver | Detalle Usuario Rol</title>
