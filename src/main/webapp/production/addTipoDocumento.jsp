							...
							<input type="hidden" value="1" name="opcion" id="opcion"/>
									<div class="field item form-group">
										...
										<div class="col-md-6 col-sm-6">
											<input type="text" class="form-control" name="txtTipo" placeholder="Ejemplo: Cheque" required="required">
										</div>
									</div>
									<div class="field item form-group">
										<label class="control-label col-md-3 col-sm-3 label-align">Acronimo: <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6">
											<input type="text" class="form-control" name="txtAcronimo" placeholder="Ejemplo: txt" required="required">
										</div>
									</div>
