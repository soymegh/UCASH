...
<title>Gesti�n | Asiento Contable</title>
	...
	<script>
		...
		$("document").ready(function(){
			...
			switch (codigoMensaje) {
				case "3":
					$.toast({
					    text: "Asiento contable editado con �xito",
					    heading: '�xito', 
					    icon: 'success',
				...
				case "7":
					$.toast({
					    ...
					    heading: '�xito', // Optional heading to be shown on the toast
				...
				case "8":
					$.toast({
					    text: "Ocurri� un error al borrar el asiento contable", // Text that is to be shown in the toast
					    heading: 'Error', // Optional heading to be shown on the toast
					    icon: 'error', // Type of toast icon
					    showHideTransition: 'slide', // fade, slide or plain
					    allowToastClose: false, // Boolean value true or false
