									  ...
									  <input type="hidden" value="1" name="opcion" id="opcion"/>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" class='optional' name="nombre"  type="text" required="required" placeholder="Nombre"/>
											</div>
										</div>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" class='optional' name="simbolo"  type="text" required="required" placeholder="Simbolo ex: $"/>
											</div>
										</div>
