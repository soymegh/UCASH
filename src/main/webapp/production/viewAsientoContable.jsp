					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Formulario <small>Mostrar Asiento Contable</small>
									</h2>
								...
								<div class="x_content">
									<form class="" action="" method="post" novalidate>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" class='optional' name="IdRol" data-validate-length-range="5,15" type="number"  readonly />
											</div>
										</div>
										<div class="field item form-group">
